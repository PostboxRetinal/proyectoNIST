  ...
  return (
    <div className="flex justify-center items-start w-full pt-10 font-sans">
      <div className="max-w-3xl bg-white p-6 rounded-xl shadow-lg flex flex-col items-center font-sans">
        ...
        {/* Texto resumen en lugar de tarjetas */}
        <div className="w-full mb-10 p-6 bg-blue-50 rounded-xl shadow-sm">
          
          <p className="text-gray-600 text-lg text-center">
            Manténgase al día con todas sus evaluaciones de conformidad para garantizar la seguridad de su organización.
          </p>
        </div>
